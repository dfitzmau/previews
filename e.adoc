...
*Description*: _Elastic Load Balancing (ELB)_ automatically distributes incoming traffic across multiple targets, such as ECS instances, and IP addresses in one or more Availability Zones. ELB supports the following load balancers:
